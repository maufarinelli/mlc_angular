translateApp.i18n.construct({
    nav_title: 'Choisissez une loterie',
    ...
    guaranteed_title: 'Lot garanti: ',

    error_message_set_numbers: 'Vous devez choisir exactement 6 numéros',
    error_message_guaranteed: 'Vous devez choisir exactement 8 chiffres, trait d\'union, 2 chiffres, comme le format suivant : 00000000-00',
    error_message_extra: 'Vous devez choisir exactement 7 chiffres avec le format suivant : 0000000',

    confirm_delete_setOfNumbers: 'Êtes-vous sûr de vouloir supprimer cette série de chiffres?',
    confirm_delete_all: 'Êtes-vous sûr de vouloir supprimer tous les sélections de numéros?',
    confirm_delete_extra: 'Etes-vous sûr de vouloir supprimer cet Extra?',
    confirm_delete_guaranteed: 'Etes-vous sûr de vouloir supprimer ce Lot garanti?',
    confirm_reset_app: 'Réinitialiser application ira supprimer tous vos numéros enregistrés. Etes-vous sûr de vouloir continuer?',
    confirm_override_extra: 'Si vous enregistrez ce nouveau numéro Extra, vous irez supprimer l\'ancien. Êtes-vous sûr de vouloir continuer?',
    confirm_override_guaranteed: 'Si vous enregistrez ce nouveau numéro de Lot garanti, vous irez supprimer l\'ancien. Êtes-vous sûr de vouloir continuer?',
