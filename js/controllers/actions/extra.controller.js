define([
    ...
    function(
        ...
        return mlcApp.controller('ExtraController', ['$scope', '$rootScope', function($scope, $rootScope) {
            // Flag
        ...
        }]).directive('myExtraDirective', function() {
            return {
                restrict: 'EA', 
                templateUrl: 'templates/my_extra.html',
