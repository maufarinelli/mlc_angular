define([
    ...
    function(
        ...
        return mlcApp.controller('GuaranteedController', function($scope, $rootScope) {
            // Flag
        ...
        }).directive('myGuaranteedDirective', function() {
            return {
                restrict: 'EA',
                templateUrl: 'templates/my_guaranteed.html',
